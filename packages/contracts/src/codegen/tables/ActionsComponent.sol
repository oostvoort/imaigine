...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActionsComponent")));
bytes32 constant ActionsComponentTableId = _tableId;

struct ActionsComponentData {
  uint256 createdAt;
  bytes actions;
}

library ActionsComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("ActionsComponent", _fieldNames);
  }
  ...
  function get(
    bytes32 interactingEntityID,
    bytes32 interactedEntityID
  ) internal view returns (ActionsComponentData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = interactingEntityID;
    _keyTuple[1] = interactedEntityID;
  ...
  function set(bytes32 interactingEntityID, bytes32 interactedEntityID, ActionsComponentData memory _table) internal {
  ...
  function set(
    ...
    bytes32 interactingEntityID,
    bytes32 interactedEntityID,
    ActionsComponentData memory _table
  ) internal {
    set(_store, interactingEntityID, interactedEntityID, _table.createdAt, _table.actions);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal view returns (ActionsComponentData memory _table) {
