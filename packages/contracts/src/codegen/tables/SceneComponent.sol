...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SceneComponent")));
bytes32 constant SceneComponentTableId = _tableId;

library SceneComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SceneComponent", _fieldNames);
  }
