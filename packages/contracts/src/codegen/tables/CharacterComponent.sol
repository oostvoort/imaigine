...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CharacterCompone")));
bytes32 constant CharacterComponentTableId = _tableId;

library CharacterComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CharacterComponent", _fieldNames);
  }
