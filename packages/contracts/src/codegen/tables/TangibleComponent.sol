...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TangibleComponen")));
bytes32 constant TangibleComponentTableId = _tableId;

library TangibleComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TangibleComponent", _fieldNames);
  }
