...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CountComponent")));
bytes32 constant CountComponentTableId = _tableId;

library CountComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CountComponent", _fieldNames);
  }
