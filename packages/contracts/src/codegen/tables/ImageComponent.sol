...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ImageComponent")));
bytes32 constant ImageComponentTableId = _tableId;
...
library ImageComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ImageComponent", _fieldNames);
  }
