...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("OwnerComponent")));
bytes32 constant OwnerComponentTableId = _tableId;

library OwnerComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("OwnerComponent", _fieldNames);
  }
