...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("InteractableComp")));
bytes32 constant InteractableComponentTableId = _tableId;

library InteractableComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("InteractableComponent", _fieldNames);
  }
