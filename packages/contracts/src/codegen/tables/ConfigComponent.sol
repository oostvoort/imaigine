...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ConfigComponent")));
bytes32 constant ConfigComponentTableId = _tableId;

library ConfigComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ConfigComponent", _fieldNames);
  }
