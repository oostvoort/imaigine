...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DescriptionCompo")));
bytes32 constant DescriptionComponentTableId = _tableId;

library DescriptionComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DescriptionComponent", _fieldNames);
  }
