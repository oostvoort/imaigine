...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BattlePointsComp")));
bytes32 constant BattlePointsComponentTableId = _tableId;

library BattlePointsComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BattlePointsComponent", _fieldNames);
  }
