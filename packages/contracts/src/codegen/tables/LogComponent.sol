...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LogComponent")));
bytes32 constant LogComponentTableId = _tableId;

library LogComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LogComponent", _fieldNames);
  }
