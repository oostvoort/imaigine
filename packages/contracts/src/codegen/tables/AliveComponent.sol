...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AliveComponent")));
bytes32 constant AliveComponentTableId = _tableId;

library AliveComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AliveComponent", _fieldNames);
  }
