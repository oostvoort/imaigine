...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PriceComponent")));
bytes32 constant PriceComponentTableId = _tableId;

library PriceComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PriceComponent", _fieldNames);
  }
