...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BattleTimeCompon")));
bytes32 constant BattleTimeComponentTableId = _tableId;

library BattleTimeComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BattleTimeComponent", _fieldNames);
  }
