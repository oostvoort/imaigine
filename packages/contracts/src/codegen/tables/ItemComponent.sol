...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ItemComponent")));
bytes32 constant ItemComponentTableId = _tableId;

library ItemComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ItemComponent", _fieldNames);
  }
